...
get_food_consumption_capita <- function(df_foodgrp_consumption, df_family_size){
  ...
  df_foodgrp_consumption_capita <- df_foodgrp_consumption %>%
    ...
    mutate(
      ...
      fruit_vegetable = ifelse(fruit_vegetable == 0, NA, fruit_vegetable)
    ) 
  ...
  df_foodgrp_consumption_capita <- df_foodgrp_consumption_capita %>%
    ...
    mutate(
      ...
      fruit_vegetable = as.numeric(fruit_vegetable) / family_size_ame %>%
        labelled(
          label = "Daily food consumption in grams per capita (fruit and vegetable)"
        )
    )
