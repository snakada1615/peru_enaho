...
stop("ここ要修正：grouping_varからyear削除ß")
    select(all_of(c(food_item_code, frequency_days, food_unit, daily_consumption,label_food, 
...
for(year_current in yearlist){
  ...
  stop("🌏😎debug: get_food_consumption_family🌏😎")
  # 所得の追加
